...
pub fn create_item_collect(item_type: &Item, path: &Path) -> Result<(), std::io::Error> {
...
pub fn run_editor_collect(editor: &str, conflict: bool, path: &Path) -> Result<(), std::io::Error> {
